...
let post_slider = new Swiper('.post-slider__body', {
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.post-slider__button_next',
		prevEl: '.post-slider__button_prev',
	},
	/*
	breakpoints: {
...
let sliderThumbs = new Swiper('.slider-productview__thumbs', {
	direction: 'vertical',
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	...
	// Dotts
	/* pagination: {
		el: '.slider-productview__pagination',
		clickable: true,
	}, */
...
let sliderImage = new Swiper('.slider-productview__body', {
	//direction: 'vertical',
	effect: 'fade',
	observer: true,
	observeParents: true,
...
let slidePortfolio = new Swiper('.portfolio-slider__body', {
	autoplay: {
		delay: 3000,
		disableOnInteraction: false,
	},
	...
	// Arrows
	navigation: {
		nextEl: '.portfolio-slider__button_next',
		prevEl: '.portfolio-slider__button_prev',
	},
...
for (let filter of filters) {
	filter.addEventListener('click', function (e) {
		...
		let itemCat = document.querySelectorAll('.item-product');
		...
		for (let index = 0; index < inputs.length; index++) {
			...
			if (input.classList.contains('_date')) {
				const calendarItem = datepicker(input, {
					...
					customMonths: ["January", "February", "March", "April", "Мay", "June", "July", "August", "September", "October", "November", "December"],
					overlayButton: 'Apply',
